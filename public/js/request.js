      ...
      columnDefs: [{
        ...
        render: function render(data, type, full, meta) {
          ...
          if (can('requests.assign') && full.status == 1) {
            buttons += "<a class=\"dropdown-item actions\" href=\"javascript:;\" data-url=\"/requests/assign\" data-state=\"2\" data-request=\"".concat(requestID, "\"><i class=\"la flaticon-user-add\"></i> Assign to me</a>");
          }

          if (can('requests.ingredients') && full.status == 2) {
            buttons += "<a class=\"dropdown-item actions\" href=\"javascript:;\" data-url=\"/requests/ingredients\" data-state=\"3\" data-request=\"".concat(requestID, "\"><i class=\"fa fa-pizza-slice\"></i> Request Ingredients</a>");
          }

          if (can('requests.deliver') && full.status == 3) {
            buttons += "<a class=\"dropdown-item actions\" href=\"javascript:;\" data-url=\"/requests/deliver\" data-state=\"4\" data-request=\"".concat(requestID, "\"><i class=\"la flaticon-paper-plane-1\"></i> Deliver Ingredients</a>");
          }

          if (can('requests.buy')) {
            buttons += "<a class=\"dropdown-item actions\" href=\"javascript:;\" data-url=\"/requests/buy\" data-state=\"\" data-request=\"".concat(requestID, "\"><i class=\"la la-money\"></i> Buy Ingredients</a>");
          }

          if (can('plates.prepare') && full.status == 4) {
            buttons += "<a class=\"dropdown-item actions\" href=\"javascript:;\" data-url=\"/requests/prepare\" data-state=\"5\" data-request=\"".concat(requestID, "\"><i class=\"la flaticon2-checkmark\"></i> Prepare</a>");
          }
