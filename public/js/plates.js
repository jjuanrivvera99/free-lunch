    ...
    dataTable = table.DataTable({
      ...
      columnDefs: [{
        ...
        render: function render(data, type, full, meta) {
          ...
          buttons += "<a class=\"dropdown-item actions\" href=\"javascript:;\" data-toggle=\"modal\" data-target=\"#kt_modal\" data-plate=\"".concat(id, "\" data-url=\"/plates/ingredients\"><i class=\"la la-edit\"></i> View Ingredients</a>");
          buttons += "</div>\n\t\t\t\t\t\t\t</span>";
          return buttons;
        }
      }]
